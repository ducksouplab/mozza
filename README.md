...
| `beta`        | Float   | One euro jitter filter beta. If there is an issue with lagging landmarks during high speed movements, increase beta. For more detailed informations on tuning the One Euro Filter, visit [http://cristal.univ-lille.fr/~casiez/1euro/]() | `0.1`                                                   |
